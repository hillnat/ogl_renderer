...
Geometry MeshImporter::ImportFromFile(const char* filename)
{
	...
	if (scene == NULL) { std::cout << "Fatal error" << std::endl; return Geometry{}; }
	...
	return MakeGeometry(allVertices.data(), allVertexCount, allIndices.data(), allIndices.size());;
	//delete[] vertices;
